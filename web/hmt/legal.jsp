            ...
            <div class="exp-content-body">
                <ol class="exp-conent-orderlist">
                    <li class="exp-content-list list-item-1">
                        ...
                        <div class="content-list-media">
                            <div class="content-list-image clearfix">
                                <p class="mt5 t2em"> 使用本网站前，请您仔细阅读下述条款。如您不同意本服务条款或花木通信息平台对其进行的修改，您可以主动取消花木通信息平台
                                    提供的服务；您一旦使用花木通信息平台提供的服务，即视为您已了解并完全同意本服务条款各项内容，包括花木通信息平台对服务条款
                                    所做的任何修改，并成为花木通信息平台的用户（以下简称“用户”）。 </p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="exp-content-list list-item-3">
                        ...
                        <div class="content-list-media">
                            <div class="content-list-image clearfix">
                                ...
                                <p class="mt5 t2em">在您按照注册页面提示填写信息、阅读并同意本协议并完成全部注册程序后或以其他花木通信息平台允许的方式实际使用中国惠
                                    农网网站服务时，您即成为花木通信息平台会员（亦称会员），花木通信息平台根据会员注册名和密码确认您的身份。您须自行负责对您的
                                    会员注册名和密码保密，且须对您在会员注册名和密码下发生的所有活动（包括但不限于发布信息资料、网上点击同意或提交各类
                                    规则协议、网上续签协议或购买服务等）承担责任。您同意：(a) 如发现任何人未经授权使用您的会员注册名或密码，或发生违反
                                    保密规定的任何其他情况，您会立即通知花木通信息平台；及 (b) 确保您在每个上网时段结束时，以正确步骤离开网站。花木通信息平台
                                    不能也不会对因您未能遵守本款规定而发生的任何损失或损毁负责。您理解花木通信息平台对您的请求采取行动需要合理时间，中国
                                    花木通网对在采取行动前已经产生的后果（包括但不限于您的任何损失）不承担任何责任。</p>

                                <p class="mt10">（7）处理交易争议</p>

                                <p class="mt10 t2em"> 花木通信息平台不涉及用户间因交易而产生的法律关系及法律纠纷，不会且不能牵涉进交易各方的交易当中。倘若您与一名或一名
                                    以上用户，或与您通过本公司网站获取其服务的第三者服务供应商发生争议，您免除花木通信息平台 (及本公司代理人和雇员) 在因
                    ...
                    <li class="exp-content-list list-item-7">
                        ...
                        <div class="content-list-media">
                            <div class="content-list-image clearfix">
                                <p class="t2em">花木通信息平台上的链接服务可以直接进入其他站点，这些链接的站点不受花木通信息平台的控制，花木通信息平台对任何与本站链接网站
                                    的内容不负责任。</p>
