...
xy_txt += '为了建立公平，诚信，透明的平台运营环境，规范卖家行为，更好的提升卖家服务，提高买家用户体验；保障花木通分销平台供应商、分销商的合法权益、维护花木通分销平台正常运营秩序，特制定本管理规范。<br />';
xy_txt += '<strong class="rule-h2">第二条</strong><br />';
xy_txt += '本管理规范用于规范供应商、分销商（统称为花木通分销平台用户）入驻和退出花木通分销平台，在花木通分销平台的经营活动过程<br />';
xy_txt += '<strong class="rule-h2">第三条</strong><br />';
xy_txt += '供应商、分销商在花木通分销平台的日常经营、管理中应诚实守信、遵纪守法，积极提升自身品质和信誉，给客户和消费者带来更好的体验。<br />';
xy_txt += '<strong class="rule-h1">第二章 定义</strong><br />';
xy_txt += '<strong class="rule-h2">第四条</strong><br />';
xy_txt += '花木通分销平台，是指为花木通分销平台用户提供分销服务的网络交易平台，域名为：fenxiao.cnhnb.com<br />';
xy_txt += '<strong class="rule-h2">第五条</strong><br />';
xy_txt += '供应商，是指通过花木通分销平台向分销商提供产品供其销售的会员。<br />';
xy_txt += '<strong class="rule-h2">第六条</strong><br />';
xy_txt += '分销商，是指在花木通网分销平台有购买商品资质的会员<br />';
xy_txt += '<strong class="rule-h2">第七条</strong><br />';
xy_txt += '同一个花木通网帐号不充许同时拥有供应商和分销商身份。<br />';
xy_txt += '<strong class="rule-h2">第八条</strong><br />';
xy_txt += '产品，是指供应商在花木通分销平台发布的商品。<br />';
xy_txt += '<strong class="rule-h1">第三章 入驻</strong><br />';
xy_txt += '<strong class="rule-h2">第九条</strong><br />';
xy_txt += '供应商和分销商入驻花木通分销平台须至少同时具备以下条件：<br />';
xy_txt += '(一)已注册为花木通网会员<br />';
xy_txt += '(二)持有并提交最新有效年检的《企业法人营业执照》副本的原件扫描件，且拟在花木通分销平台开展的经营活动不超过其《企业法人营业执照》核准的经营范围；持有并提交《组织机构代码证》的原件扫描件。以上条件的审核通过花木通网企业认证完成。<br />';
xy_txt += '(三)签署《花木通分销平台入驻协议》。<br />';
xy_txt += '(四)供应商需为花木通网农商易会员。<br />';
xy_txt += '<strong class="rule-h1">第四章 经营</strong><br />';
xy_txt += '<strong class="rule-h2">第十条</strong><br />';
xy_txt += '供应商在花木通分销平台导入产品信息时，须遵守《中国花木通网法律声明》和《中国花木通网产品发布规则》关于发布商品或信息的规定。<br />';
xy_txt += '(一) 供应商成功入驻花木通分销平台后即可导入产品。<br />';
...
xy_txt += '供应商在花木通分销平台不得发布、销售假冒伪劣产品或信息。<br />';
xy_txt += '<strong class="rule-h2">第十二条</strong><br />';
xy_txt += '供应商在产品描述页面、店铺页面等所有花木通网提供的渠道中，应当对产品的基本属性、成色、瑕疵等必须说明的信息进行真实、完整的描述。<br />';
...
xy_txt += '供应商在花木通分销平台不得同时发布两件以上的同款产品。<br />';
xy_txt += '<strong class="rule-h2">第十四条</strong><br />';
xy_txt += '花木通分销平台支持目前支持支付宝担保交易支付方式。<br />';
xy_txt += '<strong class="rule-h1">第五章 违规与处理</strong><br />';
xy_txt += '<strong class="rule-h2">第十五条</strong><br />';
xy_txt += '根据供应商违规情形的严重程度，花木通分销平台处理措施划分如下：<br />';
xy_txt += '(一)分销限权15天，1个月，三个月或永久分销限权，且不能导入新产品，并在花木通分销平台前台搜索屏蔽；<br />';
xy_txt += '(二)在花木通分销平台内下架相关产品；<br />';
xy_txt += '(三)在花木通分销平台内删除相关产品；<br />';
xy_txt += '(四)花木通分销平台首页公示；<br />';
xy_txt += '(五)永久清退出花木通分销平台。<br />';
xy_txt += '<strong class="rule-h2">第十六条</strong><br />';
xy_txt += '花木通分销平台对供应商进行独立的违规次数统计，并对供应商的违规行为采取以下处理方式：<br />';
xy_txt += '供应商一般违规次数超过五次的，将在花木通分销平台内下架供应商的所有产品；<br />';
xy_txt += '供应商严重违规次数超过十次的，将供应商清退出花木通分销平台；<br />';
xy_txt += '供应商的违规次数在每年十二月三十一日二十四时清零。<br />';
xy_txt += '<strong class="rule-h2">第十七条</strong><br />';
xy_txt += '在供应商出现违规情形，花木通分销平台经最终认定属实后，有权在不通知当事人的情况下进行处理。<br />';
xy_txt += '<strong class="rule-h2">第十八条</strong><br />';
xy_txt += '花木通网将依据《中国花木通网产品发布规则》或《中国花木通网法律声明》的相关规定判定分销商违规并进行处理。<br />';
xy_txt += '<strong class="rule-h2">第十九条</strong><br />';
xy_txt += '供应商和分销商分别授权花木通分销平台对其违规行为的责任承担进行独立判断，届时供应商和分销商应按照花木通分销平台的要求提供相关证据材料。<br />';
xy_txt += '<strong class="rule-h1">第六章 退出</strong><br />';
xy_txt += '<strong class="rule-h2">第二十条</strong><br />';
xy_txt += '供应商、分销商有权根据自己的经营情况，可主动退出花木通分销平台。<br />';
xy_txt += '<strong class="rule-h2">第二十一条</strong><br />';
xy_txt += '供应商退出后，花木通分销平台将删除其在花木通分销平台的产品信息。<br />';
...
xy_txt += '分销商若出现以下任一情形，花木通分销平台有权将其清退出花木通分销平台：<br />';
xy_txt += '(一)分销商存在《中国花木通网法律声明》中规定的严重违规行为；<br />';
xy_txt += '(一)分销商存在《中国花木通网产品发布规则》中规定的严重违规行为；<br />';
xy_txt += '<strong class="rule-h2">第二十四条</strong><br />';
xy_txt += '分销商自主申请退出或被花木通分销平台清退的，符合入驻条件后可重新申请入驻。<br />';
