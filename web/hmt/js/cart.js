       ...
       if(id.indexOf("_")){
    	...
    	$.ajax({
    			...
    			success: function(data){
                  ...
                  if(data.login){
                	  //以下是业务处理的代码
    				   $.post(cart.basePath+"order/purchase/collect",{"productId":id,"sourceFrom":sourceFrom},function(data){
    						alert(data);
    					});
    				}else{
    					//跳转至登陆域
       ...
       $(":checkbox[id$='_product']:checked").each(function(){
    	...
    	$.ajax({
    			...
    			success: function(data){
                  ...
                  if(data.login){
                	  //以下是业务处理的代码
    				   $.post(cart.basePath+"order/purchase/collect",{"productId":ids,"sourceFrom":sourceFroms},function(data){
    						alert(data);
    					});
    				}else{
    					//跳转至登陆域
