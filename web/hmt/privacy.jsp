    ...
    <div class="rightbox">
        ...
        <div class="exp-content format-exp" id="format-exp">
            <div class="exp-content-body">
                <p class="mt20 t2em" style="padding-left:10px">欢迎访问花木通信息平台！我们以本隐私声明声明对访问者隐私保护的许诺。以下文字公开我站对信息收集和使用的
                ...
                <ol class="exp-conent-orderlist">
                    ...
                    <li class="exp-content-list list-item-5">
                        ...
                        <div class="content-list-media">
                            <div class="content-list-image clearfix">
                                <p class="t2em">花木通信息平台有可能自动接收并记录您的浏览器和计算机上的信息，其中包括您的 IP 地址，花木通信息平台cookie 中的信息、软硬件
                                    特征信息、以及您需求的网页记录。</p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="exp-content-list list-item-7">
                        ...
                        <div class="content-list-media">
                            <div class="content-list-image clearfix">
                                <p class="t2em">我们不会向任何无关第三方提供，出售，出租，分享和交易用户的个人信息，但为方便您使用花木通信息平台服务及花木通信息平台关联
                                    公司或其他组织的服务（以下称其 他服务），您同意并授权花木通信息平台将您的个人信息传递给您同时接受其他服务的花木通信息平台
                                    关联公司或其他组织，或从为您提供其他服务的花木通信息平台关联公司或其他组 织获取您的个人信息。
                                    我们会对您及（或）您的公司的身份和交易数据进行综合统计，并以花木通信息平台判断合理的目的和用途将该综合统计向广告主披露。
                                ...
                                <p class="t2em">我们的网站公布了用户提交的商业机会和报价，而其他用户可以查询这些报价和商业机会。
                                    ...
                                    所收集的用户信息和资料将保存在花木通信息平台及（或）其关联公司的服务器上。</p>
                            </div>
                        </div>
                    </li>
