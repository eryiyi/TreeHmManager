...
<div class="type-head">
  <h1 class="logo">
    <a href="index.htm" title="花木通信息平台"></a>
  </h1>
...
<div class="type-nav">
  <div class="nav-con">
    ...
    <ul class="nav-con-tit">
      <li><a href="supply.htm" class="nav-tstj">供应大厅</a></li>
      <li><a href="purchase.htm" class="nav-dptj">采购大厅</a></li>
      <li><a href="center.htm" class="nav-zxhq">服务中心</a></li>
...
<div class="container wrap-1190">
    ...
    <div class="pro-list mb_10">
      ...
      <ul>
       ...
       <c:forEach items="${list}" var="e" varStatus="st">
         <li class="text-list">
           <a href="supplydetail.htm" target="_blank">
  ...
  <div class="sides mt_15">
    <div class="release-but mb_15"><a href="supplyrelease.htm" target="_blank"><i class="lee-ico lee-fb"></i> &nbsp; 发布供应</a></div>
    <div class="ad2">
      ...
      <ul>
        ...
        <c:forEach items="${listsHot}" var="e" varStatus="st">
          <li>
            ...
            <h3><a target="_blank" href="supplydetail.htm">${e.mm_msg_title}</a></h3>
            <p></p>
          </li>
        </c:forEach>
