...
<div class="container wrap-1190">
    ...
    <form action="supply.htm" id="filterForm" class="fl" style="width: 956px;">
        ...
        <div class="tabs mt_15">
            <ul class="tabs-list">
                <li class="cur" onclick="javascript:changeShowType('0');"><a>附近经纪人</a></li>
            </ul>
                ...
                <c:forEach items="${list}" var="e" varStatus="st">
                    <li class="text-list">
                        <a href="/webvProfile/toProfile.do?mm_emp_id=${e.mm_emp_id}&page=1" target="_blank">
                            ...
                            <span class="l4">${e.mm_emp_company}</span>
                            <span class="l4">${e.mm_emp_company_address}</span>
                            <span class="16"><em class="text-list-view">查看详情</em></span>
...
<script type="text/javascript" charset="UTF-8">
    function searchIndex(e, _page) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "/netNearbyController/nearby.do?page=" + _index + "&size=" + size+ "&_t=" + new Date().getTime();
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href = "/netNearbyController/nearby.do?page=" + page + "&size=" + size+ "&_t=" + new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
