            ...
            <div class="box-content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="mm_emp_ad_url" class="form-control" placeholder="图片链接"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="mm_emp_ad_num" class="form-control" placeholder="数字越大越靠前"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    <div class="form-group">
...
//                  var imageDivHtml = $("#imageDiv").html() + html;
    ...
    function saveP() {
        ...
        $.ajax({
            ...
            data: {
                "mm_emp_id": mm_emp_id,
                "mm_emp_ad_pic": imagePath,
                "mm_emp_ad_url": mm_emp_ad_url,
                "mm_emp_ad_num": mm_emp_ad_num
            },
            async: false,
            success: function (_data) {
                ...
                if (data.success) {
                    alert("执行成功");
                    window.location.href = "#module=empAd/list&mm_emp_id=" + mm_emp_id;
                } else {
                    alert("执行失败，请检查")
                }
            }
