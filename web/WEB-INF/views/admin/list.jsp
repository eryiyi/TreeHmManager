                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <c:if test="${e.mm_manager_type=='0'}">
                                <td>不限</td>
                            </c:if>
                            <c:if test="${e.mm_manager_type=='1'}">
                                <td>${e.countryName}</td>
                            </c:if>
                            <c:if test="${e.mm_manager_type=='2'}">
                                <td>${e.cityName}</td>
                            </c:if>
                            <c:if test="${e.mm_manager_type=='3'}">
                                <td>${e.provinceName}</td>
                            </c:if>
                            <c:if test="${e.mm_manager_type=='4'}">
                                <td>全国</td>
                            </c:if>
                            ...
                            <td>
                                <a class="btn btn-default btn-sm" href="#module=/admin/detail&id=${e.mm_manager_id}"
                                   role="button">管理</a>
                            </td>
                        </tr>
                    </c:forEach>
...
<script type="text/javascript">
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=/admin/list&page=" + page + "&size=" + size + "&mm_manager_is_use=" + mm_manager_is_use + "&_t=" + new Date().getTime();
        } else {
