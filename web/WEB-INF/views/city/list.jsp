...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="javascript:void(0)">城市列表</a></li>
        </ol>
                    ...
                    <div class="form-group">
                        <select class="form-control w12" id="father">
                            ...
                            <c:forEach items="${listProvinces}" var="e" varStatus="st">
                                <option value="${e.provinceID}" ${query.father == e.provinceID?'selected':''}>${e.province}</option>
                            </c:forEach>
                        </select>
                    </div>
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-default btn-sm" href="#module=/city/edit&id=${e.id}"
                                   role="button">设置</a>
                            </td>
                        </tr>
                    </c:forEach>
...
<script type="text/javascript">
    function searchOrder() {
        ...
        window.location.href = "#module=/city/list&is_use=" + is_use + "&father=" + father + "&_t=" + new Date().getTime();
    }
</script>