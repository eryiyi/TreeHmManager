...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="javascript:void(0)">城市管理</a></li>
            <li><a href="javascript:void(0)">修改城市</a></li>
        </ol>
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="city" readonly="true" value="${provinceObj.city}"
                                   class="form-control" placeholder="城市名称" data-toggle="tooltip" data-placement="bottom"
    ...
    function saveP() {
        ...
        $.ajax({
            ...
            success: function (_data) {
                ...
                if (data.success) {
                    alert("执行成功");
                    window.location.href = "#module=city/list";
                } else {
                    alert("执行失败，请检查")
                }
            }
