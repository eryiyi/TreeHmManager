      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text"  value="${aboutUs.mm_day_value}" id="mm_day_value"  class="form-control" placeholder="控制信息显示天数" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
