            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="add_one" class="form-control" placeholder="例如：VIP1半年"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="add_two" class="form-control" placeholder="例如：500"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="mm_feiyong_time" class="form-control" placeholder="数字/单位月"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="mm_feiyong_num" value="0" class="form-control"
                                   placeholder="默认0 值越大越靠前" data-toggle="tooltip" data-placement="bottom"
