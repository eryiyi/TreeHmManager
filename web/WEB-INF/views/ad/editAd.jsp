        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10 col-md-2">
              <img class="img-thumbnail" name="imagePath" id="imageDiv" src="${adObj.mm_ad_pic}" style="cursor: pointer" />
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="mm_ad_url" value="${adObj.mm_ad_url}" class="form-control" placeholder="链接" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
...
<script type="text/javascript">
  function saveP(){
    ...
    $.ajax({
      ...
      type: "POST",
      url:"/adObj/editAd.do",
      data:{"mm_ad_pic":imagePath, "mm_ad_url":mm_ad_url,"mm_ad_num":mm_ad_num,"mm_ad_id":mm_ad_id,"mm_ad_type":mm_ad_type},
      async: false,
