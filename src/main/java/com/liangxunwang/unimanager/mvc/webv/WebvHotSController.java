 ...
 */
@Controller
@RequestMapping("/webvHotSController")
public class WebvHotSController extends ControllerConstants {
...
//            }
        ...
        try {
            ...
            map.addAttribute("countryid", query.getCountryid());
